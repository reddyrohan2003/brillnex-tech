...
import { Mail, MessageCircle, BookOpen, ArrowUp } from "lucide-react";
...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>INDUSTRY-GRADE SKILLS</span> <span className="text-primary/60">✦</span>
    <span>EXPERT MENTORS</span> <span className="text-secondary/60">✦</span>
    <span>1-ON-1 REVIEWS</span> <span className="text-primary/60">✦</span>
    <span>PLACEMENT ASSISTANCE</span> <span className="text-secondary/60">✦</span>
    <span>HANDS-ON PROJECTS</span> <span className="text-primary/60">✦</span>
  </div>
);
